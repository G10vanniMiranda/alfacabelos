      ...
      <div className="relative mx-auto grid max-w-6xl gap-8 px-4 py-20 sm:px-6 md:grid-cols-[1.2fr_1fr] md:py-28">
        ...
        <div className="rounded-2xl border border-cyan-500/40 bg-zinc-900/70 p-6 shadow-[0_0_60px_rgba(6,182,212,0.15)]">
          ...
          <ul className="mt-4 space-y-3 text-sm text-zinc-200">
            <li className="rounded-lg bg-zinc-800/60 px-3 py-2">Atendimento de segunda a sabado, 09h as 19h</li>
            <li className="rounded-lg bg-zinc-800/60 px-3 py-2">Confirmacao em segundos</li>
            <li className="rounded-lg bg-zinc-800/60 px-3 py-2">Barbeiros especializados em cortes classicos e modernos</li>
          </ul>
        </div>
      </div>
    </section>
