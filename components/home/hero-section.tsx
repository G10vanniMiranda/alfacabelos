...
export async function HeroSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-white/[0.07]">
      ...
      <div className="absolute -right-24 top-10 -z-10 h-96 w-96 rounded-full bg-brand-highlight/[0.08] blur-3xl" />
      <div className="shell grid min-h-[calc(100svh-4.5rem)] items-center gap-12 py-16 lg:grid-cols-[1.08fr_.92fr] lg:py-24">
        <div className="max-w-3xl animate-fade-up">
          ...
          <h1 className="mt-5 text-[clamp(3.15rem,8vw,6.7rem)] font-semibold leading-[0.9] text-stone-50">
            Seu estilo,
            <span className="block font-normal italic text-brand-highlight">do seu jeito.</span>
          </h1>
          ...
          <ul className="mt-9 flex flex-wrap gap-x-6 gap-y-3 text-xs font-semibold uppercase tracking-[0.11em] text-copy-muted" aria-label="Diferenciais">
            <li className="flex items-center gap-2"><span className="text-brand-highlight">✓</span> Horários em tempo real</li>
            <li className="flex items-center gap-2"><span className="text-brand-highlight">✓</span> Confirmação rápida</li>
            <li className="flex items-center gap-2"><span className="text-brand-highlight">✓</span> Atendimento personalizado</li>
          </ul>
        </div>

        <aside className="premium-card relative overflow-hidden rounded-[2rem] p-6 sm:p-8" aria-label="Informações de atendimento">
          <div className="absolute right-0 top-0 h-40 w-40 rounded-full bg-brand-highlight/[0.07] blur-3xl" />
          <div className="relative">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="grid size-12 shrink-0 place-items-center rounded-full border border-brand-highlight/25 bg-brand-highlight/10 text-xl" aria-hidden="true">✦</span>
            </div>
            <dl className="mt-8 divide-y divide-white/[0.08] border-y border-white/[0.08]">
              <div className="flex justify-between gap-4 py-4">
                <dt className="text-sm text-copy-muted">Terça a sábado</dt>
                <dd className="text-right text-sm font-semibold text-stone-200">09h–12h • 14h–19h</dd>
              </div>
              <div className="flex justify-between gap-4 py-4">
                <dt className="text-sm text-copy-muted">Agendamento</dt>
                <dd className="text-right text-sm font-semibold text-stone-200">Online, em poucos minutos</dd>
              </div>
              <div className="flex justify-between gap-4 py-4">
                <dt className="text-sm text-copy-muted">Local</dt>
                <dd className="text-right text-sm font-semibold text-stone-200">Bairro Eldorado</dd>
              </div>
            </dl>
            <p className="mt-6 text-sm leading-6 text-copy-muted">Você acompanha tudo pela sua área: confirmação, contato e histórico.</p>
          </div>
        </aside>
      </div>
    </section>
