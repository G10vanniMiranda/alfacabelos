        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid grid-cols-2 gap-2 sm:min-w-72">
            <div className="rounded-xl border border-zinc-800 bg-zinc-950/70 px-4 py-3">
              <p className="text-xs uppercase tracking-wide text-copy-muted">Dias abertos</p>
              <p className="mt-1 text-2xl font-semibold text-zinc-100">{openDaysCount}/7</p>
            </div>
            <div className="rounded-xl border border-zinc-800 bg-zinc-950/70 px-4 py-3">
              <p className="text-xs uppercase tracking-wide text-copy-muted">Faixas</p>
            ...
            return (
              <div
                ...
                className={`rounded-xl border bg-zinc-950/70 p-4 transition ${
                  hasError ? "border-danger/70" : isClosed ? "border-zinc-800" : "border-zinc-700"
                }`}
              >
                ...
                <div className="mt-4 space-y-2">
                  {day.ranges.map((range, index) => (
                    ...
                    >
                      ...
                      <label className="space-y-1">
                        <span className="text-xs font-medium text-copy-muted">Fim</span>
                        <input
                          type="time"
                  ...
                  {day.ranges.length === 0 ? (
                    <div className="rounded-lg border border-dashed border-zinc-800 bg-zinc-900/40 px-4 py-5 text-sm text-copy-muted">
                      Dia sem atendimento.
                    </div>
                  ) : null}
                </div>
                ...
                <div className="mt-4 flex items-center justify-between gap-3 border-t border-zinc-800 pt-4">
                  ...
                  <button
                    ...
                    onClick={() => saveDay(day)}
                    className="button-primary shrink-0 px-4 py-2 disabled:opacity-70"
                  >
                    Salvar {dayLabel}
                  </button>
                </div>
